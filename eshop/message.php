            ...
            <div class="col-12 py-5 px-4">
                <div class="row overflow-hidden shadow rounded">
                    ...
                    <div class="col-12 col-lg-7 px-0">
                        <div class="row px-4 py-5 chat_box" id="chat_box">
                            <!-- view area -->
                        ...
                        <div class="col-12 px-2">
                            <div class="row">
                                <div class="input-group mb-3">
                                    ...
                                    <button class="btn btn-light mt-3" id="send_btn" onclick="send_msg();"><i class="bi bi-send-fill fs-2"></i></button>
                                </div>
