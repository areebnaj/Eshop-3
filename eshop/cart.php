                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        <br>
                                                        <span class="fw-bold text-black-50 fs-5">Quantity : <?php echo $product_data["qty"]; ?>&nbsp;items left</span>&nbsp;
                                                        <input type="number" class="mt-3 border border-2 border-secondary fs-4 fw-bold px-3 cardqtytext" pattern="[0-9]" value="1">
                                                        <br><br>
