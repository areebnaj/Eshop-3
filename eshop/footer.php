    ...
    <footer class="bg-dark text-white pb-5 pt-4">
        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3 tkk">
                    <h5 class="text-uppercase mt-4 text-warning">eShop</h5>
                    <p>Here we are the eShop.lk&trade; to support you for accomplish your desier by selling high
                        quality products.</p>
                </div>

                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3 text-md-center">
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    ...
                    <p><i class="bi bi-house-fill"></i> Panadura, Kaluthara, Sri Lanka</p>
                    <p><i class="bi bi-envelope-fill"></i> eShop@gmail.lk</p>
                    <p><i class="bi bi-telephone-fill"></i> +94 72 802 0860</p>
                    <p><i class="bi bi-printer-fill"></i> +94 76 603 3389</p>
