            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 align-items-start bg-dark vh-100">
                            <div class="row g-1 text-center">
                                ...
                                <div class="col-12">
                                    <hr class="border border-1 border-white" />
                                    <h4 class="text-white fw-bold" onclick="window.location='sellingHistory.php';">Selling History</h4>
                                    <hr class="border border-1 border-white" />
                                </div>
                                <div class="col-12 mb-3 d-grid">
                                    <label class="form-label fs-6 fw-bold text-white">Form Date</label>
                ...
                <div class="col-12 col-lg-10">
                    <div class="row">
                        ...
                        <div class="col-8 col-lg-10 text-white fw-bold mt-4 mb-1">
                            <h2 class="fw-bold">Dashboard</h2>
                        </div>
                        <div class="col-4 col-lg-2 text-end mt-4 mb-1">
                            <button class="btn btn-light" onclick="signout();">Log Out</button>
                        </div>
                        <div class="col-12">
                            <hr />
                        </div>
                        ...
                        <div class="col-12 bg-dark">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-9 text-end my-3">
                                    <?php
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                ...
                                ?>
                                    ...
                                    <div class="col-12 align-items-center shadow p-3">
                                        <img src="<?php echo $image_data["code"]; ?>" class="img-fluid rounded-top w-100" style="height: 300px;" />
                                    </div>
                                    <div class="col-12 text-center">
                                        <span class="fw-bold"><?php echo $product_data["title"]; ?></span><br>
                                        <span><?php echo $qty_data["qty_total"]; ?> items</span><br>
                                        <span>Rs. <?php echo $qty_data["qty_total"] * $product_data["price"]; ?> .00</span>
                                    </div>
                                ...
                                ?>
                                    ...
                                    <div class="col-12 align-items-center shadow p-3">
                                        <img src="resource/empty.svg" class="img-fluid rounded-top w-100" style="height: 300px;" />
                                    </div>
                                    <div class="col-12 text-center">
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                ...
                                ?>
                                    ...
                                    <div class="col-12 align-items-center shadow p-3">
                                        <img src="<?php echo $profile_data["path"]; ?>" class="img-fluid rounded-top w-100" style="height: 300px;" />
                                    </div>

                                    <div class="col-12 text-center">
                                        <span class="fw-bold"><?php echo $user_data1["fname"] . " " . $user_data1["lname"]; ?></span><br>
                                        <span><?php echo $user_data1["email"]; ?></span><br>
                                        <span><?php echo $user_data1["mobile"]; ?></span>
                                    </div>
                                ...
                                ?>
                                    ...
                                    <div class="col-12 align-items-center shadow p-3">
                                        <img src="profile_img/newUser.svg" class="img-fluid rounded-top w-100" style="height: 300px;" />
                                    </div>
