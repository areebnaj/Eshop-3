...
<body class="bg-info">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="offset-lg-2 col-12 col-lg-8 bg-body rounded pt-2 pb-2 mb-2">
                <div class="row">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 mb-2">
                                        <select class="form-select" id="md">
            ...
            <div class="offset-lg-2 col-12 col-lg-8 bg-body rounded pt-2 pb-2 mb-2">
                <div class="row">
                    ...
                    <div class="offset-6 offset-lg-6 col-6 col-lg-5 mt-2 mb-2">
                        <select class="form-select border border-start-0 border-top-0 border-end-0 border-2 border-primary shadow-none" id="sby">
