...
if (isset($_GET["id"])) {
    ...
    product.delivery_fee_colombo,product.delivery_fee_other,product.category_id,product.brand_has_model_id,product.colour_id,
    product.status_id,product.condition_id,product.user_email,model.name AS mname,brand.name AS bname FROM `product` INNER JOIN 
    `brand_has_model` ON brand_has_model.id=product.brand_has_model_id INNER JOIN `brand` ON brand.id=brand_has_model.brand_id 
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-12 col-lg-2 order-2 order-lg-1">
                                        ...
                                        <ul>
                                            ...
                                            ?>
                                                    ...
                                                    <li class="list-group-item active d-flex flex-column justify-content-center align-items-center border border-1 border-secondary mb-1">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="row border-bottom border-dark">
                                                    ...
                                                    ?>
                                                        <div class="col-12 my-2">
                                                            <span class="fs-5 text-primary"><b>Warranty :</b>06 months Warranty</span><br />
                                                            <span class="fs-5 text-primary"><b>Return Policy :</b>01 months return Policy</span><br />
                                                            <span class="fs-5 text-primary"><b>In Stock :</b> <?php echo $stock; ?> items left</span>
                                                        </div>
                                                    <?php
                                                    } else if ($stock == 0) {
                                                    ?>
                                                        ...
                                                        <div class="col-12 my-2">
                                                            <span class="fs-5 text-primary"><b>Warranty :</b>06 months Warranty</span><br />
                                                            <span class="fs-5 text-primary"><b>Return Policy :</b>01 months return Policy</span><br />
                                                            <span class="fs-5 text-danger"><b>Out of Stock :</b>0 items left</span>
                                                        </div>
                                                    ...
                                                    <div class="col-12 my-2">
                                                        <div class="row g-2">
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center">
                                                                <span class="fs-5 text-primary">Mohamed Rimas</span>
                                                            </div>
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center">
                            ...
                            <div class="col-12 bg-white d-flex justify-content-center">
                                <div class="row g-2 align-content-center">
                                    ...
                                    <div class="offset-1 offset-lg-0 col-3 col-lg-3">
                                        <div class="card" style="width: 18rem;">
                                            <img src="resource/mobile_images/iphone12.jpg" class="card-img-top" style="height: 150px;">
                                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <textarea cols="60" rows="10" class="form-control shadow-none" readonly><?php echo $product_data["description"]; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="row border overflow-auto" style="height: 300px;">
                                    <?php

                                    $feedback_rs = Database::search("SELECT * FROM `feedback` WHERE `product_id`='" . $pid . "' ORDER BY `date` DESC");
                                    ...
                                    ?>
                                        <div class="col-12 mt-1 mb-1">
                                            <div class="row border rounded">
                                                ...
                                                ?>
                                                <div class="col-10 mt-1 mb-1"><?php echo $user_data["fname"] . " " . $user_data["lname"]; ?></div>
