...
<head>
    ...
    <title>User Peofile | eShop</title>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 border-end">
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        ?>
                                            <img src="profile_img/newUser.svg" class="rounded mt-5" style="width: 150px;" id="viewImage" />
                                        <?php

                                        } else {

                                        ?>
                                            <img src="<?php echo $image_data["path"]; ?>" class="rounded mt-5" style="width: 150px;" id="viewImage" />
                                        <?php
                                        ...
                                        <label for="profileimg" class="btn btn-primary mt-5" style="width: 75%;" onclick="changeImage();">Update Profile Image</label>
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $data["gender_name"]; ?>" disabled />
                                            </div>
