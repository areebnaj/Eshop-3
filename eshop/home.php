                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-12 mt-3 mb-3">
                            ...
                            <a href="#" class="text-decoration-none link-dark fs-5">See All &nbsp; &rarr;</a>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="row border border-primary">
                                ...
                                <div class="col-12">
                                    ...
                                    `status_id`='1' ORDER BY `datetime_added` DESC ");
                                        ...
                                        ?>
                                            ...
                                            <div class="card col-6 col-lg-2 mt-2 mb-2 p-2" style="width: 18rem;">
                                                ...
                                                <img src="<?php echo $image_data["code"]; ?>" class="card-img-top img-thumbnail" style="height: 150px;" />
                                                <div class="card-body ms-0 m-0 text-center">
                                                    ...
                                                    ?>
                                                        ...
                                                        <button class="col-12 btn btn-outline-light border mt-2" onclick='addToWatchList(<?php echo $product_data["id"]; ?>);'>
                                                    ...
                                                    ?>
                                                        ...
                                                        <button class="col-12 btn btn-outline-light border mt-2" onclick='addToWatchList(<?php echo $product_data["id"]; ?>);'>
                                                            <i class="bi bi-heart-fill text-secondary fs-5" id='heart<?php echo $product_data["id"]; ?>'></i>
                                                        </button>
