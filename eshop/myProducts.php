                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-4 mt-1 mb-1 text-center">
                                    ...
                                    ?>
                                        ...
                                        <img src="profile_img/newUser.svg" width="90px" height="90px" class="rounded-circle" />
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-2 mb-2 my-lg-4 mx-lg-0 d-grid">
                                    <a href="addProduct.php" class="btn btn-warning fw-bold pt-3">Add Product</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row" id="sort">
                                <div class="offset-1 col-10 text-center">
                                    <div class="row justify-content-center">
                                        ...
                                        $rs_per_page = 6;
                                        $num_of_pages = ceil($product_num / $rs_per_page);

                                        $page_results = ($pageno - 1) * $rs_per_page;
                                        $selected_rs = database::search("SELECT * FROM `product` WHERE `user_email`='" . $email . "'
                                        LIMIT " . $rs_per_page . " OFFSET " . $page_results . "");
                                ...
                                <div class="offset-2 offset-lg-3 col-8 col-lg-6 text-center mb-3">
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination pagination-lg justify-content-center">
                                            ...
                                            <li class="page-item">
                                                <a class="page-link" href="<?php if ($pageno >= $num_of_pages) {
                                                                                echo "#";
                                                                            } else {
                                                                                echo "?page=" . ($pageno + 1);
                                                                            } ?>" aria-label="Next">
